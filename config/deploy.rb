...
set :application, "rubio_de_marzo"
set :scm, :git
set :repository,  "git@github.com:fguillen/RubioDeMarzo.git"
set :branch, "master"
set :deploy_to, "/home/www/rubio_de_marzo.fernandoguillen.info"
set :user, "fguillen"
set :group, "fguillen"
set :use_sudo, false

server "rubio_de_marzo.fernandoguillen.info", :web, :app, :db, :primary => true
